<script lang="ts">
    ...
    const updateChartData = async () => {
        try {
            ...
            responseData = json;    
            data = [...Object.entries(json["blocked"]).map(    
                ([key, item]) => 
                    {
                        return {
                ...
                <Column>
                    <div>
                        ...
                        <DataTable
                            ...
                            rows={Object.entries(responseData["blocked"]).flatMap(([key, item]) => {
                ...
                <Column>
                    <div>
                        ...
                        <DataTable
                            ...
                            rows={Object.entries(responseData["all"]).flatMap(([key, item]) => {
